<footer class="bg-dark py-4 mt-auto">
    <div class="container px-5">
        <div class="row align-items-center justify-content-between flex-column flex-sm-row">
            <div class="col-auto"><div class="small m-0 text-white"><?= $lang['footer_all_rights']?><br><a class="link-light small" href="https://youcontrol.com.ua/en/catalog/company_details/44845019/@imfr0mukraine">ЄДРПОУ: 44845019</a> </div></div>
            <div class="col-auto">
                <ul>
                    <li>
                        <span class="text-white mx-1">&middot;</span><a class="link-light small" href="#!"><?= $lang['footer_promises']?></a>
                    </li>
                    <li>
                        <span class="text-white mx-1">&middot;</span><a class="link-light small" href="#!"><?= $lang['footer_contacts']?></a>
                    </li>
                </ul>
            </div>
            <div class="col-auto">
