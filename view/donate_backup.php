        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" href="#by_creditcard" data-bs-toggle="tab" ><i class="fa-solid fa-credit-card buttons-cadrs"></i><?= $lang['donate_official']?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#by_paypal" data-bs-toggle="tab"><i class="fa-brands fa-paypal buttons-cadrs"></i><?= $lang['donate_paypal']?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#other" data-bs-toggle="tab"><i class="fa-solid fa-circle-dollar-to-slot buttons-cadrs"></i><?= $lang['donate_other']?></a>
                    </li>
                </ul>
            </div>
            <div class="tab-content" id="case-creditcard">
                ...
                <div class="tab-content" id="case-paypal">
                    <div class="tab-pane fade mx-4 mb-4" id="by_paypal" role="tabpanel" aria-labelledby="pills-profile-tab">
                        ...
                        <script src="https://www.paypal.com/sdk/js?client-id=AfTGgUTiw2wL1letIJ1WiSLAmJ4eLxdQnX-7CrIqG-iisg6qD2x8D3DouX-aqn35GvgLV-bjSz7pSRwx&currency=USD"></script>
